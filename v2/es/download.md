...
Vea nuestro [historial de versiones](/es/v2/release-notes). Todos los archivos son de código abierto con [licencia MIT](/license/).
...
`https://cdn.jsdelivr.net/g/riot@{{ site.v2_minor_version }}(riot.min.js+compiler.min.js)` <small>(última: {{ site.v2_minor_version }}.X)</small>

`https://cdn.jsdelivr.net/riot/{{ site.v2_minor_version }}/riot.min.js` <small>(última: {{ site.v2_minor_version }}.X)</small>
