...
View our [version history](/v2/release-notes). All Files are Open Source with [MIT License](/license/).
...
`https://cdn.jsdelivr.net/riot/{{ site.v2_minor_version }}/riot+compiler.min.js` <small>(latest {{ site.v2_minor_version }}.X)</small>
...
In your Chrome apps you must [precompile your tags](/v2/guide/compiler/#pre-compilation) because they can not compiled in runtime
